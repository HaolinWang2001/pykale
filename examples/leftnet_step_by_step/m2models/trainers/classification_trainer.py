...
#
#
# @registry.register_trainer("classification")
...
#             ),
#         )
#         evaluator, metrics = Evaluator(task='classification'), {}
...
#             [batch.y.type(torch.LongTensor).to(self.device) for batch in batch_list], dim=0
#         )
#
#         loss = self.loss_fn["classification"](out["energy"], energy_target)
#         return loss
#
#     def _compute_metrics(self, out, batch_list, evaluator, metrics={}):
#         # energy_target = torch.cat(
#         #     [batch.to(self.device) for batch in batch_list], dim=0
#         # )
#         energy_target = batch_list
#
